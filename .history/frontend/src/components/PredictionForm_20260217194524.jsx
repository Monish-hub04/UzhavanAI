...
const demoProfiles = [
  {
    name: "🌾 Rice Farmer — Tamil Nadu",
    land_size: "6.5",
    irrigated_percentage: 85,
    soil_type: "Alluvial",
    crop_type: "Rice",
    season: "Kharif",
    yield_per_acre: "22",
  ...
  {
    name: "🌿 Sugarcane Farmer — Maharashtra",
    land_size: "12",
  ...
  {
    name: "🌾 Wheat Farmer — Punjab",
    land_size: "4",
    irrigated_percentage: 60,
    soil_type: "Loamy",
    crop_type: "Wheat",
    season: "Rabi",
    yield_per_acre: "18",
  ...
  {
    name: "🥜 Groundnut Farmer — Tamil Nadu",
    land_size: "3",
    irrigated_percentage: 40,
    soil_type: "Red",
    crop_type: "Groundnut",
    season: "Rabi",
    yield_per_acre: "12",
