...
def predict(req: PredictionRequest):
    ...
    # Ensure extreme profiles land in correct buckets for demo
    ...
    # If very poor profile, dampen the regression-to-mean effect
    if prosperity < 0.4:
         predicted_income = int(predicted_income * (0.5 + prosperity)) # e.g. 0.1 prosperity -> 0.6x income
